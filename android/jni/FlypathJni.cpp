...
JNIEXPORT jint JNICALL Java_dev_flypath_FlypathAbi_count(JNIEnv*, jclass,
                                                         jlong ref) {
  return static_cast<jint>(flypath_count(value(ref)));
}

JNIEXPORT jlong JNICALL Java_dev_flypath_FlypathAbi_at(JNIEnv*, jclass,
...
JNIEXPORT jlong JNICALL Java_dev_flypath_FlypathAbi_field(JNIEnv* env, jclass,
                                                          jlong ref,
                                                          jstring name) {
...
JNIEXPORT jboolean JNICALL Java_dev_flypath_FlypathAbi_isNull(JNIEnv*, jclass,
                                                              jlong ref) {
  return flypath_is_null(value(ref)) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL Java_dev_flypath_FlypathAbi_bool(JNIEnv*, jclass,
                                                            jlong ref) {
  return flypath_bool(value(ref)) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jdouble JNICALL Java_dev_flypath_FlypathAbi_number(JNIEnv*, jclass,
                                                             jlong ref) {
...
JNIEXPORT void JNICALL Java_dev_flypath_FlypathAbi_outNull(JNIEnv*, jclass,
                                                           jlong ref) {
  flypath_out_null(out(ref));
}

JNIEXPORT void JNICALL Java_dev_flypath_FlypathAbi_outBool(JNIEnv*, jclass,
                                                           jlong ref,
                                                           jboolean value_) {
  flypath_out_bool(out(ref), value_ == JNI_TRUE);
}

JNIEXPORT void JNICALL Java_dev_flypath_FlypathAbi_outNumber(JNIEnv*, jclass,
                                                             jlong ref,
                                                             jdouble value_) {
...
JNIEXPORT void JNICALL Java_dev_flypath_FlypathAbi_outBytes(JNIEnv* env, jclass,
                                                            jlong ref,
                                                            jbyteArray value_) {
...
JNIEXPORT jlong JNICALL Java_dev_flypath_FlypathAbi_outArray(JNIEnv*, jclass,
                                                             jlong ref,
                                                             jint count) {
  return handle(flypath_out_array(out(ref), static_cast<size_t>(count)));
}

JNIEXPORT jlong JNICALL Java_dev_flypath_FlypathAbi_outElement(JNIEnv*, jclass,
                                                               jlong ref,
                                                               jint index) {
  return handle(flypath_out_element(out(ref), static_cast<size_t>(index)));
}

JNIEXPORT jlong JNICALL Java_dev_flypath_FlypathAbi_outObject(JNIEnv*, jclass,
                                                              jlong ref) {
...
JNIEXPORT jlong JNICALL Java_dev_flypath_FlypathAbi_promiseOut(JNIEnv*, jclass,
                                                               jlong ref) {
...
JNIEXPORT void JNICALL Java_dev_flypath_FlypathAbi_promiseReject(
...
JNIEXPORT void JNICALL Java_dev_flypath_FlypathInsets_publish(
