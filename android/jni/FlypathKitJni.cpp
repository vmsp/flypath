...
JNIEXPORT jint JNICALL Java_dev_flypath_kit_FlypathAbi_count(JNIEnv*, jclass,
                                                             jlong ref) {
  return static_cast<jint>(flypath_count(value(ref)));
}

JNIEXPORT jlong JNICALL Java_dev_flypath_kit_FlypathAbi_at(JNIEnv*, jclass,
                                                           jlong ref,
                                                           jint index) {
...
JNIEXPORT jlong JNICALL Java_dev_flypath_kit_FlypathAbi_field(JNIEnv* env,
                                                              jclass, jlong ref,
                                                              jstring name) {
...
JNIEXPORT jboolean JNICALL Java_dev_flypath_kit_FlypathAbi_isNull(JNIEnv*,
                                                                  jclass,
                                                                  jlong ref) {
  return flypath_is_null(value(ref)) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL Java_dev_flypath_kit_FlypathAbi_bool(JNIEnv*, jclass,
                                                                jlong ref) {
  return flypath_bool(value(ref)) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jdouble JNICALL Java_dev_flypath_kit_FlypathAbi_number(JNIEnv*,
                                                                 jclass,
                                                                 jlong ref) {
  return flypath_number(value(ref));
}

JNIEXPORT jstring JNICALL Java_dev_flypath_kit_FlypathAbi_string(JNIEnv* env,
                                                                 jclass,
                                                                 jlong ref) {
  size_t length = 0;
...
JNIEXPORT jbyteArray JNICALL Java_dev_flypath_kit_FlypathAbi_bytes(JNIEnv* env,
                                                                   jclass,
                                                                   jlong ref) {
  size_t length = 0;
...
JNIEXPORT void JNICALL Java_dev_flypath_kit_FlypathAbi_outNull(JNIEnv*, jclass,
                                                               jlong ref) {
  flypath_out_null(out(ref));
}

JNIEXPORT void JNICALL Java_dev_flypath_kit_FlypathAbi_outBool(
    JNIEnv*, jclass, jlong ref, jboolean value_) {
  flypath_out_bool(out(ref), value_ == JNI_TRUE);
}

JNIEXPORT void JNICALL Java_dev_flypath_kit_FlypathAbi_outNumber(
    JNIEnv*, jclass, jlong ref, jdouble value_) {
  flypath_out_number(out(ref), value_);
}

JNIEXPORT void JNICALL Java_dev_flypath_kit_FlypathAbi_outString(
    JNIEnv* env, jclass, jlong ref, jstring value_) {
  const std::string text = utf8(env, value_);
  flypath_out_string(out(ref), text.data(), text.size());
}

JNIEXPORT void JNICALL Java_dev_flypath_kit_FlypathAbi_outBytes(
    JNIEnv* env, jclass, jlong ref, jbyteArray value_) {
...
JNIEXPORT jlong JNICALL Java_dev_flypath_kit_FlypathAbi_outArray(JNIEnv*,
                                                                 jclass,
                                                                 jlong ref,
                                                                 jint count) {
...
JNIEXPORT jlong JNICALL Java_dev_flypath_kit_FlypathAbi_outElement(JNIEnv*,
                                                                   jclass,
                                                                   jlong ref,
                                                                   jint index) {
...
JNIEXPORT jlong JNICALL Java_dev_flypath_kit_FlypathAbi_outObject(JNIEnv*,
                                                                  jclass,
                                                                  jlong ref) {
  return handle(flypath_out_object(out(ref)));
}

JNIEXPORT jlong JNICALL Java_dev_flypath_kit_FlypathAbi_outField(JNIEnv* env,
                                                                 jclass,
                                                                 jlong ref,
                                                                 jstring name) {
  const std::string key = utf8(env, name);
...
JNIEXPORT jlong JNICALL Java_dev_flypath_kit_FlypathAbi_promiseOut(JNIEnv*,
                                                                   jclass,
                                                                   jlong ref) {
...
Java_dev_flypath_kit_FlypathAbi_promiseResolve(JNIEnv*, jclass, jlong ref) {
  flypath_promise_resolve(promise(ref));
}

JNIEXPORT void JNICALL Java_dev_flypath_kit_FlypathAbi_promiseReject(
