...
export function generateKotlin(manifest: NativeManifest): string {
  ...
  return [
    ...
    "import dev.flypath.FlypathOut",
    "import dev.flypath.FlypathEvents",
    "import dev.flypath.FlypathProps",
    "import dev.flypath.FlypathPromise",
    "import dev.flypath.FlypathTasks",
    "import dev.flypath.FlypathValue",
    "import dev.flypath.FlypathViewRegistry",
    "",
